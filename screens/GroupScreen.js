...
export default class GroupScreen extends Component {
  ...
  componentDidMount() {
        ...
        mydata.on('value', datasnap => {
          if (datasnap.val()) {
            ...
            //console.log("groupscreen data===>",this.state.dataSource.length)
            //console.log("groupscreen data===>",this.state.dataSource)
          }
        });
      }
  press = hey => {
  ...
  myCustomShare = async item => {
    const shareOptions = {
      message: `Hey! ${item.givenName} would like you to join flincs! `,
      url:
...
//   myCustomShare = async (item) => {
//     const shareOptions = {
//       message: `Hey! ${item.givenName} ${item.familyName} would like you to join flincs! `,
//       url:
//         'data:image/png;base64,',
//       // urls: [files.image1, files.image2]
//     };
...
//     return (
//       <View style={styles.container}>
//         <Text style={{fontSize:30,fontWeight:'700'}}>People on Flincs ....</Text>
...
//   ) : null}
// </View>
// <Text style={{fontSize:30,fontWeight:'700'}}>All Contacts ....</Text>
//         <View style={{flex: 1, marginBottom: 10}}>
//           <View style={{marginTop: 20}}>
//             <FlatList
...
//                         )}
//                       </View>
//                       <View   onPress = {()=>this.myCustomShare(item)}
//                         style={{
//                           flex: 1,
//                           alignItems: 'flex-end',
//                           justifyContent: 'center',
...
//                           <Text style={{fontSize:12,color:'grey'}}>People on Flincs</Text>
//                         ) : (

//                           <Text   style={{fontSize:15,color:'green',fontWeight:'bold',fontStyle:'italic'}}>invited</Text>
//                         )}
//                       </View>
//                     </TouchableOpacity>
//                   </View>
...
//   render() {
//     return (
//       <LinearGradient colors={['#fff', '#4834DF']} style={{flex: 1}}>
//          <View style={{height:50,backgroundColor:'#ccc',padding:10}}>
//            <Text style={{fontSize:15,fontWeight:'bold',letterSpacing:1}}>Already on Flincs</Text>
//          </View>
//           {this.state.dataSource.map(item => {
//             return (
//               <View
...
//         <TouchableWithoutFeedback onPress ={this.myCustomShare}style={{justifyContent:'center',alignItems:'center',paddingVertical:10}}>
//           <Text  style={{fontWeight:'bold',fontSize:20,color:'#fff'}}>Share</Text>
